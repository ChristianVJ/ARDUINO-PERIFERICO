...
/* Programa para generar numeros aleatorios en un lanzamiento
 de dado*/
...
for (int i = 0; i < 5; i++){  // Intervalo de unos 1.5 segundos generando numeros aleatorios.
  ...
  rodarElDado (numero);         // Mostrar el numero final en el dado
}
...
// dadoElectronico(); // Funcionamiento con pulsador.
probadorDado(); // Generador continuo sin botón de numeros. 
